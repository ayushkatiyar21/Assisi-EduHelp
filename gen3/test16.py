...
class VisionChatApp:
    ...
    def _build_header(self):
        ...
        # Logo only, scaled properly, no text
        ...
        # The logo is 503x146, show it at a good size in the header
        # Let's use full width for desktop header (350x102 logical, x UI_SCALE pixels)
        if logo_path:
            try:
                ...
                # logical size for CTkImage (reverse scale)
        ...
        # Remove the title text, only logo is shown
